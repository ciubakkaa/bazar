<nav class="flex justify-between items-center px-5 py-4 md:px-8 max-w-[1200px] mx-auto">
  ...
  <div class="flex gap-3 items-center">
    ...
    <a href="/register" class="bg-bazar-yellow text-bazar-dark font-semibold text-[15px] px-6 py-2.5 rounded-full hover:-translate-y-0.5 transition-transform no-underline">
      Inregistreaza-te
    </a>
  </div>
</nav>
...
<section class="max-w-[1200px] mx-auto px-5 md:px-8 pt-8 md:pt-16 pb-10 grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 items-center">
  <div>
    ...
    <div class="flex gap-3 flex-wrap">
      <a href="/register" class="inline-flex items-center gap-2 bg-gradient-to-br from-bazar-yellow to-bazar-yellow-dim text-bazar-dark px-8 py-3.5 rounded-full font-bold text-base no-underline hover:-translate-y-0.5 hover:shadow-lg transition-all">
        Incepe acum &rarr;
      </a>
      <a href="/checklist" class="inline-flex items-center gap-2 bg-bazar-gray-100 text-bazar-gray-700 px-6 py-3.5 rounded-full font-medium text-base no-underline hover:bg-bazar-gray-200 hover:text-bazar-dark transition-all">
        Vezi cum arata
      </a>
    </div>
  </div>
  ...
  <div class="relative order-first md:order-last overflow-hidden md:overflow-visible">
    ...
    <!-- Floating stat card -->
    <div class="absolute -bottom-4 -left-2 md:left-4 bg-white rounded-bazar-lg px-4 py-3 shadow-[0_8px_40px_rgba(44,47,48,0.08)] -rotate-2 z-20">
      <div class="flex items-center gap-2">
        <span class="w-2.5 h-2.5 rounded-full bg-bazar-green animate-pulse"></span>
        <span class="text-xs font-semibold text-bazar-dark">2,400+ colegi gasiti azi</span>
      </div>
    </div>
...
<section id="features" class="max-w-[1200px] mx-auto px-5 md:px-8 mt-10 flex flex-col gap-4">
  ...
  <div class="bg-bazar-yellow rounded-bazar-xl p-7 hover:-translate-y-1 hover:shadow-[0_8px_40px_rgba(44,47,48,0.06)] transition-all grid grid-cols-1 md:grid-cols-2 gap-6 items-center">
    <div>
      ...
      <h3 class="font-heading font-bold text-xl text-bazar-dark mb-2">Gaseste colegul de apartament ideal</h3>
      <p class="text-sm text-bazar-dark/70 leading-relaxed">Quiz de compatibilitate + filtre. Afla daca va potriviti inainte sa semnati contractul.</p>
    </div>
    <div class="flex items-center justify-center md:justify-end gap-[-8px]">
      <div class="w-14 h-14 rounded-full bg-gradient-to-br from-bazar-purple to-bazar-orange flex items-center justify-center text-white font-bold text-sm border-2 border-bazar-yellow -ml-2 first:ml-0">AM</div>
      <div class="w-14 h-14 rounded-full bg-gradient-to-br from-green-400 to-cyan-500 flex items-center justify-center text-white font-bold text-sm border-2 border-bazar-yellow -ml-3">RI</div>
      <div class="w-14 h-14 rounded-full bg-gradient-to-br from-rose-400 to-pink-500 flex items-center justify-center text-white font-bold text-sm border-2 border-bazar-yellow -ml-3">SD</div>
      <div class="ml-3 bg-bazar-dark text-white text-xs font-bold px-3 py-1.5 rounded-full">98% compatibil</div>
    </div>
  </div>
  <!-- Row 3: Q&A card -->
  <div class="bg-white rounded-bazar-xl p-7 hover:-translate-y-1 hover:shadow-[0_8px_40px_rgba(44,47,48,0.06)] transition-all">
    <div class="w-12 h-12 rounded-bazar-sm bg-rose-100 flex items-center justify-center text-2xl mb-4">❓</div>
    <h3 class="font-heading font-bold text-xl mb-2">Intreaba orice</h3>
    <p class="text-sm text-bazar-gray-500 leading-relaxed">Pune intrebari. Studentii din anii mari raspund. Fara intrebari stupide.</p>
  </div>
</section>
...
<section class="relative overflow-hidden bg-bazar-dark rounded-[20px] md:rounded-[28px] mx-4 md:mx-8 max-w-[1136px] lg:mx-auto mt-12 md:mt-20 mb-12 md:mb-16 px-5 md:px-8 py-10 md:py-12 text-center">
  ...
  <a href="/register" class="relative z-10 inline-flex items-center gap-2 bg-gradient-to-br from-bazar-yellow to-bazar-yellow-dim text-bazar-dark px-8 py-3.5 rounded-full font-bold text-base no-underline hover:-translate-y-0.5 transition-transform">
    Creeaza cont &rarr;
  </a>
</section>
